...
BAJA_PRIORIDAD
	...
	BTFSS	INTCON,INT0IF		; PREGUNTO POR MI BANDERA DE EXTERNA
	GOTO	FIN_INTER		; SALGO DE ISR
	BCF	INTCON,INT0IF		; LIMPIO BANDERA DE ISR EXTERNA
	GOTO	ISR_EXTERNA
FIN_INTER
	MOVWF	W_TEMP			; MUEVO EL ULTIMA VALOR DE W 
	MOVFF	STATUS,STATUS_TEMP	; DE STATUS Y DE BSR
...
;*********************************************************************************	
	BSF	INTCON,INT0IE		; HABILITACION DE INTERRUPCION EXTERNA
	BCF	INTCON,INT0IF		; LIMPIO BANDERA
	BSF	INTCON,GIE
;*********************************************************************************
...
;*********************************************************************************
	#DEFINE	    DIGITO1	 LATB,7
	#DEFINE	    DIGITO2	 LATB,6
	#DEFINE	    ISR_PIN	 PORTB,0
...
ISR_EXTERNA
	...
	GOTO	FIN_INTER		; CONTINUO EL CONTEO
	...
	GOTO	FIN_INTER		; CONTINUO CONTEO
...
MUESTRA_DISPLAY	
	BSF	DIGITO1			; PRENDO DISPLAY 1
	BCF	DIGITO2			; APAGO DISPLAY 2
	...
	BSF	DIGITO2			; PRENDO DISPLAY 1
	BCF	DIGITO1			; APAGO DISPLAY 2
