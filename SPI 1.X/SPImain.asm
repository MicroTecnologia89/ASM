...
;*********************************************************************************    
	...
	TEST_V	EQU B'01010101'
	
	BSF	CS
PRINCIPAL
	MOVLW	CERO_V			; CARGO EL VALOR A TRANSMITIR EN W
	CALL	SPI_DATA		; LLAMO RUTINA DE TRANSMISION SPI
	CALL	RET_1s			; RET GENERAL

	
	MOVLW	UNO_V			; CARGO EL VALOR A TRANSMITIR EN W
	CALL	SPI_DATA		; LLAMO RUTINA DE TRANSMISION SPI
	CALL	RET_1s			; RET GENERAL
	
	MOVLW	DOS_V			; CARGO EL VALOR A TRANSMITIR EN W
	CALL	SPI_DATA		; LLAMO RUTINA DE TRANSMISION SPI
	CALL	RET_1s			; RET GENERAL
	
	MOVLW	TRES_V			; CARGO EL VALOR A TRANSMITIR EN W
	CALL	SPI_DATA		; LLAMO RUTINA DE TRANSMISION SPI
	CALL	RET_1s			; RET GENERAL
