...
;*********************************************************************************
;------------------------------ PUERTO SERIAL 1 ----------------------------------
	MOVLW	0x06			; CARGO VALORES
	MOVWF	SPBRGH1			; PARA GENERACION DE BAUIDOS
	MOVLW	0x82			; CON REGISTRO DE 16 BITS
	MOVWF	SPBRG1			; CARGADO EN AMBOS REGISTROS
	BSF	TRISC,6			; PIN TX COMO ENTRADA
	BSF	TRISC,7			; PIN RX COMO ENTRADA	
	MOVLW	B'00100100'		; HABILITO COMUNICACIÓN ASÍNCRONA
	MOVWF	TXSTA1			; TRANSMITE PUERTO 1
	MOVLW	B'10010000'		; HABILITO RECEPCION DE 8 BITS
	MOVWF	RCSTA1			; REGISTRO RX PUERTO 1
	MOVLW	B'00001000'		; GENERADOR DE BAUDIOS 16 BITS
	MOVWF	BAUDCON1		; VELOCIDAD DEL PUERTO	9600	
	BCF	PIR1,RC1IF		; LIMPIO BANDERA RECEPCIÓN 	
;*********************************************************************************
;*********************************************************************************	
;*********************************************************************************		
...
TX_DATO
	MOVWF	TXREG1			; MUEVO EL DATO A REGISTRO DE TRANSMISION
TXD
	BTFSS	PIR1,TXIF		; ESPERO LA BANDERA BUFFER LIMPIO
	GOTO	TXD			; WAIT 
	BCF	PIR1,TX1IF		; LIMPIO BANDERA DE TRANSMISION
	RETURN				; REGRESO
