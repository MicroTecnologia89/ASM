...
TABLA_NUMERO
	...
	; DIRECCIONO LA TABLA
	MOVLW   UPPER(TABLA1)		; DIRECCION UPPER TABLA
	MOVWF   TBLPTRU			; SE ASIGNA
	MOVLW   HIGH(TABLA1)		; DIRECCION HIGH TABLA
	MOVWF   TBLPTRH			; SE ASIGNA 
	MOVLW   LOW(TABLA1)		; DIRECCION LOW TABLA
...
TABLA1:   DB 0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67	
