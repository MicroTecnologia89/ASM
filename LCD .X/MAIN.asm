...
;*********************************************************************************
	...
	#DEFINE	MOV_CW	    PORTA,0
	#DEFINE	MOV_CCW	    PORTA,1

	CLRF	VAR1			; LIMPIO VARIABLE 1
	CLRF	VAR3			; LIMPIO VARIABLE 3
	MOVLW	0XFF			; CARGO 255 A WREG
	MOVWF	VAR2			; A VARIABLE 2
	MOVF	0XFF			; CARGO 255 A WREG
	MOVWF	VAR4			; PARA ASIGNARLO A VARIABLE 4
	CALL	LCD_CLEAR
PRINCIPAL
	CALL	PRINT_VALOR1		; IMPRIMO VALOR 1
	CALL	PRINT_VALOR2		; IMPRIMO VALOR 2
	CALL	PRINT_VALOR3		; IMPRIMO VALOR 3
	CALL	PRINT_VALOR4		; IMPRIMO VALOR 4 
	CALL	RET_1s
	INCF	VAR1,F			; INCREMENTO VARIABLE
	INCF	VAR3,F			; INCREMENTO VARIABLE
	INCF	VAR3,F			; INCREMENTO VARIABLE	
	DECF	VAR2,F			; DECRMENTO VARIABLE
	DECF	VAR4,F			; DECREMENTO VARIABLE
	DECF	VAR4,F			; DECREMENTO VARIABLE	
	GOTO	PRINCIPAL	
...
PRINT_VALOR1
	...
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	;*********************************************************
	MOVF	VAR1,W			; MUEVO VARIABLE A WREG
...
;*******************************************************************************
PRINT_VALOR2
	CALL	LCD_L2			; POSICIONAMIENTO LCD L2
	MOVLW	' '			; CARACTER A MOSTRAR
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	MOVLW	'V'			; CARACTER A MOSTRAR
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	...
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	;*********************************************************
	MOVF	VAR2,W			; MUEVO VARIABLE A WREG
	CALL	CONVERSION_BCD		; LLAMO RUTINA DE CONVERSIÓN BCD
	MOVF	AUX_CENTENAS,W		; MUEVO EL RESULTADO CENTENAS A W 
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 	
	MOVF	AUX_DECENAS,W		; MUEVO EL RESULTADO DECENAS A W 
...
;*******************************************************************************
PRINT_VALOR3
	CALL	LCD_L3			; POSICIONAMIENTO LCD L3
	MOVLW	' '			; CARACTER A MOSTRAR
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	MOVLW	'V'			; CARACTER A MOSTRAR
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	...
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	;*********************************************************
	MOVF	VAR3,W			; MUEVO VARIABLE A WREG
	CALL	CONVERSION_BCD		; LLAMO RUTINA DE CONVERSIÓN BCD
	MOVF	AUX_CENTENAS,W		; MUEVO EL RESULTADO CENTENAS A W 
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 	
	MOVF	AUX_DECENAS,W		; MUEVO EL RESULTADO DECENAS A W 
...
;*******************************************************************************
PRINT_VALOR4
	CALL	LCD_L4			; POSICIONAMIENTO LCD L4
	MOVLW	' '			; CARACTER A MOSTRAR
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
	MOVLW	'V'			; CARACTER A MOSTRAR
	CALL	ENVIAR_DATO		; ENVIO CARACTER A LCD 
